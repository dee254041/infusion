...
export default function UnauthorizedPage() {
  ...
  // Auto-redirect to first allowed page when user has permissions
  useEffect(() => {
  ...
  const handleReload = async () => {
    await update() // Refetch session in case permissions were updated
    router.replace(firstAllowed)
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-red-50/30 to-stone-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-6">
